...
SELECT
    ...
    -- to_char(current_date, ' YYYY "A" MM "B" DD "C" ') 날짜3     -- OK
    -- to_char(current_date, ' YYYY "Y" MM "M" DD "D" ') 날짜3     -- OK
FROM
    dual;
...
SELECT
    ...
    length(to_char(1234, 'L99999')) AS length
FROM
    dual;

-- 현재의 세션에 적용되는 "국제화 설정" 테이블: NLS_SESSION_PARAMETERS
