...
CREATE TABLE dept03 (
    ...
    CONSTRAINT dept03_deptno_pk PRIMARY KEY(deptno, dname)
);
...
CREATE TABLE emp07 (
    ...
    ename       VARCHAR2(15),
    myDeptNo    NUMBER(2),
    myDeptName  VARCHAR2(15),
    
     CONSTRAINT emp07_myDeptNo_fk
        FOREIGN KEY(myDeptNo, myDeptName) REFERENCES dept03(deptno, dname)
);

-- SELECT ...
-- FROM emp02, dept03
-- WHERE
--     emp02.myDeptNo = dept03.deptno
--     AND emp02.myDeptName = dept03.dname
